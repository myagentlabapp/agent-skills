...
description: "Validating A/B test implementations including traffic splitting accuracy, statistical significance calculation, metric tracking, and experiment cleanup."
version: 1.0.0
author: qaskills
license: MIT
tags: [ab-testing, experimentation, statistical, traffic-split, metrics]
...
1. **Quality First** — Ensure all ab-testing implementations follow industry best practices and produce reliable, maintainable results.
...
5. **Documentation** — Ensure all ab-testing configurations and test patterns are well-documented for team understanding.
...
2. **Choose the right tools** — Select appropriate ab-testing tools based on project requirements
