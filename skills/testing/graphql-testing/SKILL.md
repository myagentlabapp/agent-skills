...
description: "Comprehensive GraphQL API testing including query/mutation testing, schema validation, resolver testing, subscription testing, and N+1 query detection."
version: 1.0.0
author: qaskills
license: MIT
tags: [graphql, api, schema, query, mutation]
...
You are an expert QA engineer specializing in graphql testing. When the user asks you to write, review, debug, or set up graphql related tests or configurations, follow these detailed instructions.
