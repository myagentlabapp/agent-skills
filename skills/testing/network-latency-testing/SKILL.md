...
description: "Network latency simulation and testing for measuring application behavior under various network conditions including high latency, packet loss, and bandwidth constraints."
version: 1.0.0
author: qaskills
license: MIT
tags: [network, latency, simulation, bandwidth, packet-loss]
...
1. **Quality First** — Ensure all network implementations follow industry best practices and produce reliable, maintainable results.
...
5. **Documentation** — Ensure all network configurations and test patterns are well-documented for team understanding.

## When to Use This Skill

- When setting up network for a new or existing project
- When reviewing or improving existing network implementations
- When debugging failures related to network
- When integrating network into CI/CD pipelines
- When training team members on network best practices
...
2. **Choose the right tools** — Select appropriate network tools based on project requirements
