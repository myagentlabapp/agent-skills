...
description: "Frontend performance testing covering bundle size analysis, render performance, animation frame rate, React re-render detection, and lazy loading verification."
version: 1.0.0
author: qaskills
license: MIT
tags: [frontend, performance, bundle-size, render, optimization]
testingTypes: [performance]
frameworks: [webpack, vite]
...
1. **Quality First** — Ensure all frontend implementations follow industry best practices and produce reliable, maintainable results.
...
5. **Documentation** — Ensure all frontend configurations and test patterns are well-documented for team understanding.
...
2. **Choose the right tools** — Select appropriate frontend tools based on project requirements
