...
description: "Testing LLM-powered features including output quality validation, hallucination detection, token usage monitoring, and prompt regression testing."
version: 1.0.0
author: qaskills
license: MIT
tags: [llm, ai, output-testing, hallucination, prompt]
...
1. **Quality First** — Ensure all llm implementations follow industry best practices and produce reliable, maintainable results.
...
5. **Documentation** — Ensure all llm configurations and test patterns are well-documented for team understanding.

## When to Use This Skill

- When setting up llm for a new or existing project
- When reviewing or improving existing llm implementations
- When debugging failures related to llm
- When integrating llm into CI/CD pipelines
- When training team members on llm best practices
...
2. **Choose the right tools** — Select appropriate llm tools based on project requirements
