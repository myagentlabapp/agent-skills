...
description: "Django application testing with TestCase, fixtures, factory_boy, model testing, view testing, middleware testing, and Django REST framework testing."
version: 1.0.0
author: qaskills
license: MIT
tags: [django, python, orm, factory-boy, drf]
