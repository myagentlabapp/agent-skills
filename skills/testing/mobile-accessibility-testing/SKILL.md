...
1. **Quality First** — Ensure all mobile-a11y implementations follow industry best practices and produce reliable, maintainable results.
...
5. **Documentation** — Ensure all mobile-a11y configurations and test patterns are well-documented for team understanding.

## When to Use This Skill

- When setting up mobile-a11y for a new or existing project
- When reviewing or improving existing mobile-a11y implementations
- When debugging failures related to mobile-a11y
- When integrating mobile-a11y into CI/CD pipelines
- When training team members on mobile-a11y best practices
...
1. **Assess the project** — Understand the tech stack (swift, kotlin, typescript) and existing test infrastructure
2. **Choose the right tools** — Select appropriate mobile-a11y tools based on project requirements
