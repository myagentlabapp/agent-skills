...
description: "Automated web performance auditing using Google Lighthouse for Core Web Vitals, accessibility, SEO, and best practices scoring with CI integration."
version: 1.0.0
author: qaskills
license: MIT
tags: [lighthouse, performance, core-web-vitals, audit, pwa]
testingTypes: [performance]
frameworks: [lighthouse]
