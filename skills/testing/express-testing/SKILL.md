---
name: "Express.js Testing Patterns"
description: "Express.js API testing with supertest, middleware testing, route handler testing, error handling verification, and authentication testing."
version: 1.0.0
author: qaskills
license: MIT
tags: [express, nodejs, supertest, middleware, api]
testingTypes: [unit, integration, api]
frameworks: [express, jest, mocha]
...
You are an expert QA engineer specializing in express.js testing patterns. When the user asks you to write, review, debug, or set up express related tests or configurations, follow these detailed instructions.

## Core Principles

1. **Quality First** — Ensure all express implementations follow industry best practices and produce reliable, maintainable results.
...
5. **Documentation** — Ensure all express configurations and test patterns are well-documented for team understanding.

## When to Use This Skill

- When setting up express for a new or existing project
- When reviewing or improving existing express implementations
- When debugging failures related to express
- When integrating express into CI/CD pipelines
- When training team members on express best practices

## Implementation Guide

### Setup & Configuration

When setting up express, follow these steps:

1. **Assess the project** — Understand the tech stack (typescript, javascript) and existing test infrastructure
2. **Choose the right tools** — Select appropriate express tools based on project requirements
...
Integrate express into your CI/CD pipeline:
