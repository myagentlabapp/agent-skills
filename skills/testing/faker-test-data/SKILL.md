...
description: "Generating realistic test data with Faker libraries for names, addresses, emails, dates, and domain-specific data with reproducible seed control."
version: 1.0.0
author: qaskills
license: MIT
...
1. **Quality First** — Ensure all faker implementations follow industry best practices and produce reliable, maintainable results.
...
5. **Documentation** — Ensure all faker configurations and test patterns are well-documented for team understanding.

## When to Use This Skill

- When setting up faker for a new or existing project
- When reviewing or improving existing faker implementations
- When debugging failures related to faker
- When integrating faker into CI/CD pipelines
- When training team members on faker best practices
...
2. **Choose the right tools** — Select appropriate faker tools based on project requirements
