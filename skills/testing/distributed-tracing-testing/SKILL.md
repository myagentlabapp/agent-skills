---
name: "Distributed Tracing Testing"
description: "Testing distributed tracing implementations including context propagation, span correlation, baggage handling, and trace sampling verification."
version: 1.0.0
author: qaskills
license: MIT
tags: [distributed-tracing, context-propagation, correlation, sampling, jaeger]
testingTypes: [integration]
frameworks: [jaeger, zipkin]
...
1. **Quality First** — Ensure all distributed-tracing implementations follow industry best practices and produce reliable, maintainable results.
...
5. **Documentation** — Ensure all distributed-tracing configurations and test patterns are well-documented for team understanding.
...
1. **Assess the project** — Understand the tech stack (python, java, go) and existing test infrastructure
2. **Choose the right tools** — Select appropriate distributed-tracing tools based on project requirements
