---
name: "Cron Job & Scheduled Task Testing"
description: "Testing scheduled tasks and cron jobs including execution timing, idempotency, failure recovery, overlap prevention, and timezone handling."
version: 1.0.0
author: qaskills
license: MIT
tags: [cron, scheduled, idempotency, timing, recovery]
...
You are an expert QA engineer specializing in cron job & scheduled task testing. When the user asks you to write, review, debug, or set up cron related tests or configurations, follow these detailed instructions.

## Core Principles

1. **Quality First** — Ensure all cron implementations follow industry best practices and produce reliable, maintainable results.
...
5. **Documentation** — Ensure all cron configurations and test patterns are well-documented for team understanding.

## When to Use This Skill

- When setting up cron for a new or existing project
- When reviewing or improving existing cron implementations
- When debugging failures related to cron
- When integrating cron into CI/CD pipelines
- When training team members on cron best practices

## Implementation Guide

### Setup & Configuration

When setting up cron, follow these steps:

1. **Assess the project** — Understand the tech stack (python, typescript, go) and existing test infrastructure
2. **Choose the right tools** — Select appropriate cron tools based on project requirements
...
Integrate cron into your CI/CD pipeline:
