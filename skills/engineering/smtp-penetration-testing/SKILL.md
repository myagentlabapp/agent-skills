...
```bash
# Method 1: VRFY
smtp-user-enum -M VRFY -U users.txt -t 127.0.0.1 -p 25

# Method 2: RCPT with timing analysis
smtp-user-enum -M RCPT -U users.txt -t 127.0.0.1 -p 25 -d target.com
...
[+] 127.0.0.1:25 - Found user: admin
[+] 127.0.0.1:25 - Found user: root
[+] 127.0.0.1:25 - Found user: postmaster
```
