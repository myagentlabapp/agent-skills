...
- `references/official-spec/00-agentskills-spec.md` —— Agent Skills 开放标准官方规范全文（agentskills/agentskills 24.3k★，格式权威定义）
- `references/official-spec/tutorial/` —— 官方入门教程 7 篇（build-first-skill → deep-dive → readme-wizard 实战 → share）
- 当规范理解有分歧时，以官方 spec 为准。
