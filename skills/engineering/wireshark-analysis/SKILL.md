...
```
# IP address filters
ip.addr == 127.0.0.1              # All traffic to/from IP
ip.src == 127.0.0.1               # Source IP only
ip.dst == 127.0.0.1               # Destination IP only
...
(ip.src == 127.0.0.1 || ip.src == 127.0.0.1) && tcp.port == 443
```
